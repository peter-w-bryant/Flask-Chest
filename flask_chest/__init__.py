...
class FlaskChest:
    ...
    def generic_db_write(self, schema_name, variable_name, variable_value, request_id=None):
        """
        ...
        """
        if self.schemas[schema_name]['type'] == 'sqlite':
            sqlite_write(self.db_uri, schema_name, variable_name, variable_value, request_id)
        pass